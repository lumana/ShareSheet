...
pipeline {
    ...
    environment {
        ...
        APP_NAME = 'ShareSheet'
        BUILD_NAME = 'ShareSheet'
        
        APP_TARGET = 'ShareSheet'
        APP_SCHEME = 'ShareSheet'
        APP_PROJECT = 'ShareSheet.xcodeproj'
        APP_WORKSPACE = 'ShareSheet.xcworkspace'
        APP_TEST_SCHEME = 'ShareSheetTest'
